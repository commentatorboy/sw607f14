\subsection{Changes made to Kategoriværktøjet}\label{subsec:collab_catresult}
...
The potential bug where it was possible to avoid selecting a child by using the Back button, was a general issue involving the Giraf-Component \ct{GProfileSelector}, and can best be fixed by the group working on GUI. Therefore it was unfortunately not handled this year, but should be looked at next year.
