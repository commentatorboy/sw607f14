...
\hline
	ID 	&	Iced	&	Issues	&	Description		&	 Es. hours \\\hline
	21	& 	 	&	Create view-mode	& 	Blur pictiures out of focus. Only full pictures(no half/auto adjust). Marker-choice: arrow or highlight, locked or dynamic position of marker. Possible settings for up to 7 pictograms.	&	128 hours	\\\hline
	...
	34	&	&	Implement choices in sequences		&	Implement sequences so that they can contain the option to make choices.	& 	16 hours  \\\hline
...
\section{Sprint 4 - Product Backlogs}
\begin{longtable} { | c | c | p{5cm} | p{5cm} | c | } 
\hline
	ID 	&	Iced	&	Issues	&	Description		&	 Es. hours \\\hline
